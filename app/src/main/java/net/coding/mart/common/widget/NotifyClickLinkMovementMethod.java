 ...
 */
public class NotifyClickLinkMovementMethod extends LinkMovementMethod {
    ...
    public static MovementMethod getInstance() {
        if (sInstance == null) {
            sInstance = new NotifyClickLinkMovementMethod();
        }

        return sInstance;
    }

    private static NotifyClickLinkMovementMethod sInstance;
}
